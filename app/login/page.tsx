...
export default function LoginPage() {
    return (
        <section className="w-full lg:h-dvh lg:p-0 md:p-10 p-5 relative flex justify-center items-center lg:text-gray-900 text-white">
            <div className="bg-white/30 backdrop-blur-xl w-full rounded-lg p-10 lg:p-0 lg:px-10 lg:py-6 lg:overflow-y-auto flex-1/2 space-y-2 flex justify-center items-center flex-col lg:space-y-3 lg:h-full lg:rounded-none lg:bg-white">
                <form className="space-y-3 w-full">
                    ...
                    <div>
                        <button className="w-full cursor-pointer text-white bg-primary py-3 rounded-lg">Login</button>
                    </div>
                </form>
                <div>
                    <p>
                        Don&apos;t have an account? <span className="text-primary"><Link href="/regiter">Register</Link></span>
                    </p>
                </div>
                <div className="text-center my-4 flex items-center w-full justify-center">
