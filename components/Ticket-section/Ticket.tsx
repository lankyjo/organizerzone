...
const Ticket = ({imageUrl, price, title, date, venue, description}: Ticket) => {
  return (
    <li className="w-full bg-gray-500/50 p-10 flex max-sm:flex-col border-2 border-white rounded-2xl gap-10 max-w-4xl mx-auto">
        ...
        <div className="flex-1/2">
          ...
          <h3 className="text-4xl uppercase max-sm:text-xl font-extrabold">{title}</h3>
          ...
          <div className="pt-5 space-y-5">
            ...
            <div className="flex justify-center max-sm:text-sm gap-10 max-sm:justify-between max-sm:gap-0">
              <button className=" py-2 px-5 max-sm:text-[8px] bg-primary text-gray-950 rounded-4xl max-sm:px-4 max-sm:py-2 max-sm:rounded-3xl">Get Ticket</button>
