...
import { FaFacebook, FaInstagram, FaSpotify, FaTwitter, FaYoutube, FaEnvelope, FaPhone } from "react-icons/fa";

const Footer = () => {
  return (
    <footer id='contact' className='padding text-white md:space-y-20 space-y-16'>
      <div className='grid  grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3'>
        <div id='logo' className='space-y-5'>
          ...
          <div>
            <Image src={'/logo.crop.png'} width={100} height={100} alt='ogaticket logo' />
          </div>
        </div>
